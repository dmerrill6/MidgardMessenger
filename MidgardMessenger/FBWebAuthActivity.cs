...
{
	[Activity (Label = "FBWebAuthActivity")]			
	public class FBWebAuthActivity : Activity
	{
		FacebookClient fb;
		string url;
		string appId;
		...
		{ 
			FBWebAuthActivity parentActivity;

			public FBWebClient (FBWebAuthActivity parentActivity)
			{
